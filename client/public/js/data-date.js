    ...
    $("#search-box-letter").keyup(function(){
      $('#all-data').attr('id','search-box-result');
       if($("#search-box-letter").val() != "" || $("#search-box-frequency").val() !=""){
         $.ajax({
           url:   `/api/searchdate?letter=${$("#search-box-letter").val()}&frequency=${$("#search-box-frequency").val()}`,
           method: `GET`,
           success: function(result){
             console.log(result)
            let isisearch = ""
     ...
     $("#search-box-frequency").keyup(function(){
       ...
       if($("#search-box-letter").val() != "" || $("#search-box-frequency").val() !=""){
         $.ajax({
           url:   `/api/searchdate?date=${$("#search-box-letter").val()}&frequency=${$("#search-box-frequency").val()}`,
           method: `GET`,
           success: function(result){
             console.log(result);
             let isisearch = ""
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            $("#all-data .btn-dlt").click(function() {
                ...
                $.ajax({
                    url: 'http://localhost:9000/api/datadate/' + idData,
                    type: 'DELETE',
                    success: function(result) {
